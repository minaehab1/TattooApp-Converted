  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <motion.div
        ...
        className="flex-grow p-4 max-w-md mx-auto"
      >
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mb-6">
          <TabsList className="grid w-full grid-cols-3 bg-muted rounded-full p-1">
            <TabsTrigger value="myRewards" className="rounded-full data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              My Rewards
            </TabsTrigger>
            <TabsTrigger value="referrals" className="rounded-full data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              Referrals
            </TabsTrigger>
            <TabsTrigger value="ambassador" className="rounded-full data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
              Ambassador
            </TabsTrigger>
          </TabsList>
